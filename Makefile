...
CFLAGS = -I. -I./lib -mlongcalls -I$(SDK_HOME)/include -I$(SDK_HOME)/driver_lib/driver -I$(SDK_HOME)/driver_lib/include/driver
LDLIBS = -nostdlib -Wl,--start-group -lc -lgcc -ldriver -lmain -lnet80211 -lwpa -llwip -lpp -lphy -lc -lmbedtls -lssl -lcrypto -lwps -Wl,--end-group
...
$(PROGRAM): $(PROGRAM).o lib/button.o
